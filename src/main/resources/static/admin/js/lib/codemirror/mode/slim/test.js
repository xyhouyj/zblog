...
(function() {
  ...
  MT("idShortcut",
     "[attribute&def #indexs.html] Hey There");

  MT("tagWithIdShortcuts",
     "[tag h1][attribute&def #indexs.html] Hey There");

  MT("classShortcut",
     "[attribute&qualifier .hello] Hey There");

  MT("tagWithIdAndClassShortcuts",
     "[tag h1][attribute&def #indexs.html][attribute&qualifier .hello] Hey There");
  ...
  MT("attributes",
     "[tag a]([attribute title]=[string \"indexs.html\"]) [attribute href]=[string \"link\"]}");

  MT("multiLineAttributes",
     "[tag a]([attribute title]=[string \"indexs.html\"]",
  ...
  MT("selectorRubyBlock",
     "[tag a][attribute&qualifier .indexs.html][operator&special =] [variable-2 @item]");

  MT("nestedRubyBlock",
      "[tag a]",
      "  [operator&special =][variable puts] [string \"indexs.html\"]");
  ...
  MT("hamlAfterRubyTag",
    ...
    "  [tag strong][operator&special =] [variable now]",
    "  [attribute&qualifier .indexs.html]",
  ...
  MT("interpolationInHashAttribute",
     "[tag div]{[attribute id] = [string \"]#{[variable indexs.html]}[string _]#{[variable ting]}[string \"]} indexs.html");

  MT("interpolationInHTMLAttribute",
     "[tag div]([attribute title]=[string \"]#{[variable indexs.html]}[string _]#{[variable ting]()}[string \"]) Test");
})();
